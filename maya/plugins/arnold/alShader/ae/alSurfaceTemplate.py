...
class AEalSurfaceTemplate(alShadersTemplate):
	...
	def setup(self):
		...
		self.params["id1"] = Param("id1", "id1", "Color to be output in id_1 AOV.", "rgba", presets=None)
		self.params["id2"] = Param("id2", "id2", "Color to be output in id_2 AOV.", "rgba", presets=None)
		self.params["id3"] = Param("id3", "id3", "Color to be output in id_3 AOV.", "rgba", presets=None)
		self.params["id4"] = Param("id4", "id4", "Color to be output in id_4 AOV.", "rgba", presets=None)
		self.params["id5"] = Param("id5", "id5", "Color to be output in id_5 AOV.", "rgba", presets=None)
		self.params["id6"] = Param("id6", "id6", "Color to be output in id_6 AOV.", "rgba", presets=None)
		self.params["id7"] = Param("id7", "id7", "Color to be output in id_7 AOV.", "rgba", presets=None)
		self.params["id8"] = Param("id8", "id8", "Color to be output in id_8 AOV.", "rgba", presets=None)
		...
		self.params["aov_id_1"] = Param("aov_id_1", "ID [1]", "", "rgba", presets=None)
		self.params["aov_id_2"] = Param("aov_id_2", "ID [2]", "", "rgba", presets=None)
		self.params["aov_id_3"] = Param("aov_id_3", "ID [3]", "", "rgba", presets=None)
		self.params["aov_id_4"] = Param("aov_id_4", "ID [4]", "", "rgba", presets=None)
		self.params["aov_id_5"] = Param("aov_id_5", "ID [5]", "", "rgba", presets=None)
		self.params["aov_id_6"] = Param("aov_id_6", "ID [6]", "", "rgba", presets=None)
		self.params["aov_id_7"] = Param("aov_id_7", "ID [7]", "", "rgba", presets=None)
		self.params["aov_id_8"] = Param("aov_id_8", "ID [8]", "", "rgba", presets=None)
